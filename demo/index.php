...
// 		$httpHeader  = curl_getinfo($ch);
	...
	$url = "http://15456cr684.51mypc.cn/github/eclipse/weixinsdk/phpsdk/index.php/jssdk/getSignature";
	$res = http_curl($url,true);	
?>
...
<div class="wxapi_container">
    ...
    <div class="lbox_close wxapi_form">
      ...
      <h3 id="menu-pay">测试</h3>
      <span class="desc"><?php echo $res->appId;?></span>
      <button class="btn btn_primary" id="chooseWXPay">chooseWXPay</button>
    </div>
  </div>
</body>
